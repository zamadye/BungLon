...
(async function main() {
  ...
  console.log('\n[E] integrasi index.html / game.js / config');
  {
    ...
    ok('urutan script: config → adsManager → referralSystem → game.js',
      at('config.example.js') === 0 && at('config.js') === 1 && at('adsManager.js') === 2 && at('referralSystem.js') === 3 && at('game.js') === 4, scripts);
